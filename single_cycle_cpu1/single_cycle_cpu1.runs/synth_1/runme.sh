...
HD_PWD='D:/Vivado/Project/single_cycle_cpu1/single_cycle_cpu1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log single_display.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source single_display.tcl
