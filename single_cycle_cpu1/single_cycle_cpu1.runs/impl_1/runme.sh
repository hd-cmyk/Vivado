...
HD_PWD='D:/Vivado/Project/single_cycle_cpu1/single_cycle_cpu1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log single_display.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source single_display.tcl -notrace
